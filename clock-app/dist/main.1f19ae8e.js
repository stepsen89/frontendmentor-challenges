...
var timeApi = "https://worldtimeapi.org/api/ip";
var quotesApi = "https://programming-quotes-api.herokuapp.com/Quotes/random";
var locationApi = "https://api.freegeoip.app/json/?apikey=080dafb0-90de-11ec-a4c8-338b1cebf5d9";
document.addEventListener("DOMContentLoaded", function () {
  // dom elements for quote
  var quoteText = document.querySelector("#quoteText");
  var quoteAuthor = document.querySelector("#quoteAuthor"); // dom element to refresh the quote

  var refreshImage = document.querySelector("#refresh"); // dom elements for greeting, time and zone in clock

  var timeDisplay = document.querySelector("#time");
  var zoneDisplay = document.querySelector("#zone");
  var greetingDisplay = document.querySelector("#greeting"); // dom elements to interact depending on nighttime/daytime

  var dayTimeIcon = document.querySelector("#daytime-icon");
  var border = document.querySelector("#border");
  var body = document.querySelector("body"); // dom elements for location information

  var locationDisplay = document.querySelector("#location"); // dom element to show popup and change arrow icon, hide quote

  var moreButton = document.querySelector("#moreButton");
  var arrow = document.querySelector("#arrow");
  var popup = document.querySelector("#popup");
  var top = document.querySelector("#top"); // dom elements in popup

  var curDay = document.querySelector("#curDay");
  var curDayOfWeek = document.querySelector("#curDayOfWeek");
  var curWeekNumber = document.querySelector("#curWeekNumber"); // get random quote
  ...
  var getRandomQuote = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _axios.default.get(quotesApi, {
                accept: "application/json"
              });

            case 3:
              response = _context.sent;
              quoteText.innerHTML = "\" ".concat(response.data.en, " \"");
    ...
    return function getRandomQuote() {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _axios.default.get(locationApi, {
                accept: "application/json"
              });

            case 3:
              response = _context2.sent;
              locationDisplay.innerHTML = "in ".concat(response.data.city, ", ").concat(response.data.country_code);
  ...
  var setCurrentTimeUpdate = function setCurrentTimeUpdate() {
    var time = new Date();
    var daytimeMatch = {
      day: {
        css: "daytime",
    ...
    var current = time.getHours() <= 18 && time.getHours() >= 6 ? daytimeMatch.day : daytimeMatch.night;
    var adjustMinutes = time.getMinutes() < 10 ? "0".concat(time.getMinutes()) : time.getMinutes();
    timeDisplay.innerHTML = "".concat(time.getHours(), ":").concat(adjustMinutes);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _axios.default.get(timeApi, {
                accept: "application/json"
              });
